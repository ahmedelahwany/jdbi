...
public class Main {
    public static void main(String[] args) {
        ...
        try(Handle handle = jdbi.open())
        {
            ...
            bookDao.insert(new Book("9781409181637", "Alex Michaelides","The Silent Patient : The Richard and Judy bookclub pick and Sunday Times Bestseller", Book.Format.PAPERBACK, "Orion Publishing Co",LocalDate.parse("2020-01-15"), 352, true));
